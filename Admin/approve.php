...
<div id="main">
  ...
  <div class="container">
    ...
    <form class="Approve" action="" method="post">
        <!-- <input class="form-control" type="text" name="approve" placeholder="Yes" required=""><br> -->
...
<?php
  ...
  {
    mysqli_query($db,"UPDATE  `issue_book` SET  `approve` =  'Yes', `issue` =  '$_POST[issue]', `return` =  '$_POST[return]' WHERE username='$_SESSION[name]' and bid='$_SESSION[bid]';");
